...
public class MainClient extends WindowAdapter implements ActionListener
{
	...
	private MainClient()
	{
		mainFrame= new JFrame("STEGNOGRAPHY WITH AUDIO, VIDEO and IMAGE");
		...
		title = new JLabel("STEGNOGRAPHY WITH AUDIO,VIDEO and IMAGE", JLabel.CENTER);
